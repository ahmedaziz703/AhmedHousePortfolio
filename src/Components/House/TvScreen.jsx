...
export default function TvScreen(props)
{
    ...
    <group ref={logosRef}>
      <mesh 
        ...
        scale={[0.09, 0.1, 0.1]} 
        onClick={() => handleClick("https://github.com/ahmedaziz703")}
      >
        <planeGeometry/>
      ...
      <mesh 
        ...
        scale={[0.09, 0.1, 0.1]} 
        onClick={() => handleClick("https://x.com/ahmedaziz703")}
      >
        <planeGeometry/>
      ...
      <mesh 
        ...
        scale={[0.09, 0.1, 0.1]} 
        onClick={() => handleClick("https://www.linkedin.com/in/ahmed-alrages-810778344/")}
      >
        <planeGeometry/>
      ...
      <mesh 
        ...
        scale={[0.09, 0.1, 0.1]}
        onClick={() => handleClick("https://github.com/ahmedaziz703/AhmedHousePortfolio")}
      >
        <planeGeometry/>
      ...
      <mesh 
        ...
        onClick={() => handleClick("mailto:ahmedazizz703@gmail.com")}
      >
        <planeGeometry/>
